...
def stars_list():
    ...
    star = list(db.mystar.find({'like':{'$gt':-1}},{'_id':False}).sort('like',-1))
    return jsonify({'result': 'success','msg':'list 연결되었습니다!','data': star})
...
def star_delete():
    ...
    db.mystar.update_one({'name':name_receive},{'$set':{'like':-1}})
